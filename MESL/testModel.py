...
#模型等级
parser.add_argument('-l', '--level', type=int, default=4, help='the level of model')
#模型名字
...
# 获取模型文件列表
model_server_baseline_files = utils.get_model_weight_files(args.data_name+"/"+args.model_name+'-MESL-server')
print(model_server_baseline_files)
model_client_baseline_files = utils.get_model_weight_files(args.data_name+"/"+args.model_name+'-MESL-client')
