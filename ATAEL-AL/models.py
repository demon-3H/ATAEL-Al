...
def EncodeNET(inplane,hiddem_size):
    return nn.Sequential(
        nn.Conv2d(inplane,hiddem_size,kernel_size=3,stride=1,padding=1,bias=False),

    )
def DecodeNET(inplane,hiddem_size):
    return nn.Sequential(
        nn.ConvTranspose2d(inplane,hiddem_size,kernel_size=1,stride=1,bias=False),
    )
...
class Block(nn.Module):
    ...
    def forward(self,x):
        ...
        return x
class MobileNetPlusClient(nn.Module):
    def __init__(self,in_channels=3):
        super(MobileNetPlusClient,self).__init__()
        self.conv1=nn.Conv2d(in_channels,32,kernel_size=3,stride=1,padding=1,bias=False)
        self.bn1=nn.BatchNorm2d(32)
        self.a11 = EncodeNET(32, 16)
        self.a12 = EncodeNET(16, 8)
        self.a13 = EncodeNET(8, 4)
        self.a14 = nn.ReLU()
        self.SE = SE_Block(4)
    def forward(self,x):
        x=F.relu(self.bn1(self.conv1(x)))
...
class MobileNetPlusServer(nn.Module):
    # (128,2) 表示 卷积 out_channels=128, stride=2。默认情况下 卷积 stride=1
    cfg = [64, (128,2), 128, (256,2), 256, (512,2), 512, 512, 512, 512, 512, (1024,2), 1024]
    def __init__(self,num_classes=10):
        super(MobileNetPlusServer,self).__init__()
        self.a21 = DecodeNET(4, 8)
        self.a22 = DecodeNET(8, 16)
        self.a23 = DecodeNET(16, 32)
...
class ResNetPlusClient(nn.Module):
    ...
    def __init__(self,in_channels=3):
        ...
        self.a11 = EncodeNET(64, 32)
        self.a12 = EncodeNET(32, 16)
        self.a13 = EncodeNET(16, 8)
        self.a14 = EncodeNET(8, 4)
        self.a15 = nn.ReLU()
        self.SE = SE_Block(4)
...
class ResNetPlusServer(nn.Module):
...
class VGG16PlusClient(nn.Module):
    def __init__(self,in_channels=3):
        super(VGG16PlusClient,self).__init__()
...
class VGG16PlusServer(nn.Module):
    def __init__(self, num_classes=10):
        super(VGG16PlusServer,self).__init__()
...
def ClientNet(model_name,in_channels=3):
    if model_name=="mobilenet":
            print("MobileNetPlusClient")
            return MobileNetPlusClient(in_channels)
    elif model_name=="VGG16":
            print("VGG16PlusClient")
            return VGG16PlusClient(in_channels)
    else:
            print("ResNetPlusClient")
            return ResNetPlusClient(in_channels)
def ServerNet(model_name,num_classes=10):
    if model_name=="mobilenet":
            print("MobileNetPlusServer")
            return MobileNetPlusServer(num_classes)
    elif model_name=="VGG16":
            print("VGG16PlusServer")
            return VGG16PlusServer(num_classes)
    else:
            print("ResNetPlusServer")
            return ResNetPlusServer(ResBlock,num_classes)